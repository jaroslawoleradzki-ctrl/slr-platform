  ...
  beforeEach(() => {
    ...
    vi.spyOn(extractionApi, 'getProjectTemplate').mockResolvedValue({
      ...
      publication_fields: [
        ...
        { field_key: 'study_design', name: 'Typ badania (Study Design)', data_type: 'enum', allowed_values: ['Cohort Study'] },
      ],
      repeating_groups: [{
        group_key: 'study_arms', name: 'Ramiona badania / Grupy badane (Study Arms)', min_items: 1, max_items: 10,
        field_definitions: [{ field_key: 'arm_name', name: 'Nazwa grupy / ramienia', data_type: 'text', is_required: true }],
      }],
    });
