...
class TestBibtexEndpoint:
    ...
    def test_empty_project_yields_valid_empty_artifact(self, environment) -> None:
        ...
        response = client.get(f"/api/v1/projects/{PROJECT_ID}/exports/bibtex")
        assert response.status_code == 200
        assert response.text.startswith("%% Generated by SLR Platform")
        assert parse_bibtex(response.text) == []
        assert response.headers["content-disposition"] == 'attachment; filename="exports_project_publications.bib"'
    ...
    def test_two_calls_are_byte_identical(self, environment) -> None:
        ...
        first = client.get(f"/api/v1/projects/{PROJECT_ID}/exports/bibtex").text
        second = client.get(f"/api/v1/projects/{PROJECT_ID}/exports/bibtex").text

        def strip_d8(t: str) -> str:
            return "\n".join(line for line in t.splitlines() if not line.startswith("%% Generated by"))

        assert strip_d8(first) == strip_d8(second)
...
class TestRisEndpoint:
    ...
    def test_empty_project_yields_valid_empty_artifact(self, environment) -> None:
        ...
        assert response.status_code == 200
        assert response.text.startswith("%% Generated by SLR Platform")
        assert parse_ris(response.text) == []
    ...
    def test_two_calls_are_byte_identical(self, environment) -> None:
        ...
        first = client.get(f"/api/v1/projects/{PROJECT_ID}/exports/ris").text
        second = client.get(f"/api/v1/projects/{PROJECT_ID}/exports/ris").text
