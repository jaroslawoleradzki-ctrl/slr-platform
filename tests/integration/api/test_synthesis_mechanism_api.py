...
def test_mechanism_category_api_crud(client):
    ...
    # 1. List empty
    res = test_client.get(f"/projects/{proj_id}/synthesis/mechanisms/categories")
    ...
    res = test_client.post(f"/projects/{proj_id}/synthesis/mechanisms/categories", json=create_payload)
    ...
    res = test_client.put(
        f"/projects/{proj_id}/synthesis/mechanisms/categories/idle_reduction",
        json=update_payload,
    )
    assert res.status_code == 200
    ...
    # 5. Delete
    res = test_client.delete(f"/projects/{proj_id}/synthesis/mechanisms/categories/idle_reduction")
...
def test_mechanism_workspace_and_synthesis_flow(client):
    ...
    res = test_client.post(
        f"/projects/{proj_id}/synthesis/mechanisms/categories",
        json={
            "category_id": "idle_reduction",
            "name": "Idle-Time Reduction",
    ...
    res = test_client.post(
        f"/projects/{proj_id}/synthesis/mechanisms/pathways/{pathway_id}/assign",
        json=assign_payload,
    )
    assert res.status_code == 200
    ...
    # 4. Approve Pathway
    res = test_client.post(
        f"/projects/{proj_id}/synthesis/mechanisms/pathways/{pathway_id}/approve",
    ...
    res = test_client.get(f"/projects/{proj_id}/synthesis/mechanisms/synthesis")
    assert res.status_code == 200
    chains = res.json()
    assert len(chains) == 1
