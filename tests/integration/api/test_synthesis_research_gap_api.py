...
def test_empty_workspace(client):
    ...
    res = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps")
...
def test_workspace_missing_project(client):
    ...
    res = test_client.get("/api/v1/projects/missing/synthesis/research-gaps")
...
def test_create_and_get_gap(client):
    ...
    res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/research-gaps",
        json={
    ...
    gap_id = gap["gap_id"]
    res = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{gap_id}")
    assert res.status_code == 200
...
def test_create_gap_missing_project(client):
    test_client, _ = client
    res = test_client.post(
        "/api/v1/projects/missing/synthesis/research-gaps",
...
def test_update_and_delete_gap(client):
    ...
    res = test_client.put(
        f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{gap_id}",
    ...
    res = test_client.delete(f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{gap_id}")
...
def test_link_evidence_flow(client):
    ...
    res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{gap_id}/links",
    ...
    res = test_client.delete(f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{gap_id}/links/{link_id}")
    assert res.status_code == 204
...
def test_link_evidence_rejects_missing_gap_and_target(client):
    ...
    res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{uuid4()}/links",
        json={"link_type": "analytical_relation", "target_id": str(seeded["relation_id"])},
    )
    assert res.status_code == 404
...
def test_evidence_candidates_endpoint(client):
    ...
    res = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps/evidence-candidates")
    assert res.status_code == 200
    candidates = res.json()
...
def test_project_isolation(client):
    ...
    res = test_client.post(
        f"/api/v1/projects/{proj_a}/synthesis/research-gaps",
        json={"gap_type": "thematic", "title": "Gap", "rationale": "Justification.", "researcher_id": "r"},
    )
    gap_id = res.json()["gap_id"]

    res = test_client.get(f"/api/v1/projects/{proj_b}/synthesis/research-gaps/{gap_id}")
    assert res.status_code == 404

    res = test_client.get(f"/api/v1/projects/{proj_b}/synthesis/research-gaps")
...
def test_workspace_stats_counts(client):
    ...
    res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/research-gaps/{thematic_gap_ids[0]}/links",
        json={"link_type": "analytical_relation", "target_id": str(seeded["relation_id"])},
    )
    assert res.status_code == 201

    data = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps").json()
...
def test_wrong_project_update_delete_rejected(client):
    ...
    res = test_client.post(
        "/api/v1/projects/test-api-gap-iso-a/synthesis/research-gaps",
        json={"gap_type": "thematic", "title": "Gap", "rationale": "Justification.", "researcher_id": "r"},
    )
    gap_id = res.json()["gap_id"]

    res = test_client.put(
        f"/api/v1/projects/test-api-gap-iso-b/synthesis/research-gaps/{gap_id}",
        json={"title": "Hijacked"},
    )
    assert res.status_code == 404

    res = test_client.delete(f"/api/v1/projects/test-api-gap-iso-b/synthesis/research-gaps/{gap_id}")
    assert res.status_code == 404

    res = test_client.get(f"/api/v1/projects/test-api-gap-iso-a/synthesis/research-gaps/{gap_id}")
    assert res.status_code == 200
...
def test_no_gap_score_fields_in_api_response(client):
    ...
    workspace = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps").json()
    ...
    candidates = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/research-gaps/evidence-candidates").json()
