...
def test_get_workspace_classifications_empty_categories(client: TestClient):
    resp = client.get("/projects/proj-api-test/synthesis/classifications")
...
def test_category_crud_endpoints(client: TestClient):
    ...
    create_resp = client.post(
        "/projects/proj-api-test/synthesis/categories/lean",
    ...
    update_resp = client.put(
        "/projects/proj-api-test/synthesis/categories/lean/custom_lean",
    ...
    create_e_resp = client.post(
        "/projects/proj-api-test/synthesis/categories/energy",
        json={"category_id": "custom_energy", "name": "Custom Energy", "display_order": 1},
    )
    assert create_e_resp.status_code == 201

    del_resp = client.delete("/projects/proj-api-test/synthesis/categories/energy/custom_energy")
...
def test_mapping_and_approval_flow_endpoints(client: TestClient):
    ...
    map_resp = client.put(
        "/projects/proj-api-test/synthesis/classifications",
        json={
    ...
    app_resp = client.post(
        "/projects/proj-api-test/synthesis/classifications/approve",
        json={
            "term_type": "lean_practice",
            "source_value": "5S Visuals",
    ...
    ws_resp = client.get("/projects/proj-api-test/synthesis/classifications")
...
def test_api_validation_errors(client: TestClient):
    # Unknown project -> 404
    resp = client.get("/projects/unknown-proj/synthesis/classifications")
