...
def test_get_synthesis_matrix_api(client):
    ...
    response = test_client.get(f"/api/v1/projects/{proj_id}/synthesis/matrix")
...
def test_get_matrix_cell_detail_api(client):
    ...
    response = test_client.get(
        f"/api/v1/projects/{proj_id}/synthesis/matrix/cell-detail",
...
def test_unit_conversion_preview_and_save_api(client):
    ...
    preview_res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/relations/{relation_id}/convert-unit",
        json={"target_unit": "MJ"},
    )
    ...
    save_res = test_client.post(
        f"/api/v1/projects/{proj_id}/synthesis/relations/{relation_id}/save-converted-unit",
        json={"target_unit": "MJ"},
    )
