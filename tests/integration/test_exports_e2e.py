...
class TestExportsEndToEnd:
    ...
    def test_full_workflow_all_seven_exports_and_provenance_and_readonly(self, workflow_setup):
        ...
        for url, expected_media, ext in endpoints_reviewer_a:
            ...
            assert res.headers.get("X-Application-Version") == "0.6.9"
        ...
        assert f"%% Generated by SLR Platform 0.6.9 for project {project_id} at {bib_ts}" in bib_res.text
        assert f"%% Generated by SLR Platform 0.6.9 for project {project_id} at {ris_ts}" in ris_res.text
    ...
    def test_empty_project_returns_valid_empty_artifacts(self, workflow_setup):
        ...
        assert "%% Generated by SLR Platform 0.6.9" in res.text
